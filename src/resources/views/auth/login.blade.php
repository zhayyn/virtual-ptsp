...
<head>
    ...
    <title>@yield('title', 'Virtual PTSP') - Login</title>
        ...
        <div class="glass-card rounded-2xl p-8">
            ...
            <a href="{{ route('auth.google') }}"
               class="social-btn flex items-center justify-center space-x-3 w-full py-3 rounded-xl mb-6 cursor-pointer">
                ...
                <span class="text-white font-medium">Masuk dengan Google</span>
            </a>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox"
                                   name="remember"
                                   class="w-4 h-4 rounded border-gray-600 bg-clerk-surface text-clerk-primary focus:ring-clerk-primary">
                            <span class="text-sm text-gray-400">Ingat saya</span>
                        </label>
                        <a href="#" class="text-sm text-clerk-primary hover:underline">Lupa password?</a>
                    </div>
            ...
            <div class="mt-6 text-center">
                ...
                <a href="{{ route('register') }}" class="text-clerk-primary hover:underline ml-1">Daftar gratis</a>
            </div>
        </div>
